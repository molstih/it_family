...
const achievements = [
    {
        ...
        description: ' Получение высшего образования в области информационных технологий всеми членами семьи.\n' +
            '   Участие детей в олимпиадах по информатике и программированию.\n'
    },
    {
        icon: '👨‍💻',
    ...
    },
    {
        ...
        description: 'Наша семья практикует введение новых (семейное катание на роликах, удивительные поездки по стране) и поддержка старых традиций (семейный ужин)',
    },
    {
        icon: '🌍',
